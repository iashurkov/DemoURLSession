...
enum Colors {
    ...
    static let darkBlue = #colorLiteral(red: 0.003921568627, green: 0.3019607843, blue: 0.4117647059, alpha: 1)
    static let gray = #colorLiteral(red: 0.9411764706, green: 0.9568627451, blue: 0.9764705882, alpha: 1)
}
